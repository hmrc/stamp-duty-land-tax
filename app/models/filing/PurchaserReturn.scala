...
object CreatePurchaserRequest {
  implicit val format: OFormat[CreatePurchaserRequest] =
    Json.format[CreatePurchaserRequest]
}
...
object CreatePurchaserReturn {
  implicit val format: OFormat[CreatePurchaserReturn] =
    Json.format[CreatePurchaserReturn]
}
...
object UpdatePurchaserRequest {
  implicit val format: OFormat[UpdatePurchaserRequest] =
    Json.format[UpdatePurchaserRequest]
}
...
object UpdatePurchaserReturn {
  implicit val format: OFormat[UpdatePurchaserReturn] =
    Json.format[UpdatePurchaserReturn]
}
...
object DeletePurchaserRequest {
  implicit val format: OFormat[DeletePurchaserRequest] =
    Json.format[DeletePurchaserRequest]
}
...
object DeletePurchaserReturn {
  implicit val format: OFormat[DeletePurchaserReturn] =
    Json.format[DeletePurchaserReturn]
}
...
object CreateCompanyDetailsRequest {
  implicit val format: OFormat[CreateCompanyDetailsRequest] =
    Json.format[CreateCompanyDetailsRequest]
}
...
object CreateCompanyDetailsReturn {
  implicit val format: OFormat[CreateCompanyDetailsReturn] =
    Json.format[CreateCompanyDetailsReturn]
}
...
object UpdateCompanyDetailsRequest {
  implicit val format: OFormat[UpdateCompanyDetailsRequest] =
    Json.format[UpdateCompanyDetailsRequest]
}
...
object UpdateCompanyDetailsReturn {
  implicit val format: OFormat[UpdateCompanyDetailsReturn] =
    Json.format[UpdateCompanyDetailsReturn]
}
...
object DeleteCompanyDetailsRequest {
  implicit val format: OFormat[DeleteCompanyDetailsRequest] =
    Json.format[DeleteCompanyDetailsRequest]
}
...
object DeleteCompanyDetailsReturn {
  implicit val format: OFormat[DeleteCompanyDetailsReturn] =
    Json.format[DeleteCompanyDetailsReturn]
}
