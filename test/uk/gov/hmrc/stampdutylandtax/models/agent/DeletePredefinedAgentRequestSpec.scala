...
class DeletePredefinedAgentRequestSpec extends AnyWordSpec with Matchers {
    ...
    "read and write a fully-populated with all optional fields" in {
      val json = Json.parse (
        """
          |{
          | "storn": "STORN12345",
          | "agentReferenceNumber":"agentReference"
          |}
          |""".stripMargin
      )

      val model = json.as[DeletePredefinedAgentRequest]
      model.storn mustBe "STORN12345"
      model.agentReferenceNumber mustBe "agentReference"
    }
  }
