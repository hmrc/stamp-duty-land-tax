...
final class PurchaserReturnsServiceSpec extends SpecBase {
  ...
  private def mkUpdatePurchaserReturn(
  ...
  private def mkDeletePurchaserReturn(
  ...
  private def mkUpdateCompanyDetailsReturn(
      updated: Boolean = true
  ...
  private def mkDeleteCompanyDetailsReturn(
      deleted: Boolean = true
  ...
  "PurchaserReturnsService createPurchaser" - {
    ...
    "must delegate to connector (happy path)" in {
      ...
      val result: CreatePurchaserReturn =
    ...
    "must return different results for different requests" in {
      ...
      val request1: CreatePurchaserRequest =
        mkCreatePurchaserRequest("STORN11111", "RRF-001")
      val request2: CreatePurchaserRequest =
        mkCreatePurchaserRequest("STORN22222", "RRF-002")
      implicit val hc: HeaderCarrier = HeaderCarrier()

      when(connector.createPurchaser(eqTo(request1))(any[HeaderCarrier]))
        .thenReturn(
          Future.successful(mkCreatePurchaserReturn("PRF-001", "PID-001"))
        )
      when(connector.createPurchaser(eqTo(request2))(any[HeaderCarrier]))
        .thenReturn(
          Future.successful(mkCreatePurchaserReturn("PRF-002", "PID-002"))
        )

      service
        .createPurchaser(request1)
        .futureValue mustBe mkCreatePurchaserReturn("PRF-001", "PID-001")
      service
        .createPurchaser(request2)
        .futureValue mustBe mkCreatePurchaserReturn("PRF-002", "PID-002")
    ...
    "must handle different flag combinations" in {
      ...
      val trusteeRequest: CreatePurchaserRequest =
        mkCreatePurchaserRequest().copy(isTrustee = Some("YES"))
      val connectedRequest: CreatePurchaserRequest =
        mkCreatePurchaserRequest().copy(isConnectedToVendor = Some("YES"))
      val noAgentRequest: CreatePurchaserRequest =
        mkCreatePurchaserRequest().copy(isRepresentedByAgent = Some("NO"))
      implicit val hc: HeaderCarrier = HeaderCarrier()

      when(connector.createPurchaser(eqTo(trusteeRequest))(any[HeaderCarrier]))
        .thenReturn(Future.successful(mkCreatePurchaserReturn()))
      when(
        connector.createPurchaser(eqTo(connectedRequest))(any[HeaderCarrier])
      )
        .thenReturn(Future.successful(mkCreatePurchaserReturn()))
      ...
      service
        .createPurchaser(trusteeRequest)
        .futureValue mustBe mkCreatePurchaserReturn()
      service
        .createPurchaser(connectedRequest)
        .futureValue mustBe mkCreatePurchaserReturn()
      service
        .createPurchaser(noAgentRequest)
        .futureValue mustBe mkCreatePurchaserReturn()

      verify(connector).createPurchaser(eqTo(trusteeRequest))(
        any[HeaderCarrier]
      )
      verify(connector).createPurchaser(eqTo(connectedRequest))(
        any[HeaderCarrier]
      )
      verify(connector).createPurchaser(eqTo(noAgentRequest))(
        any[HeaderCarrier]
      )
      verifyNoMoreInteractions(connector)
    }
    ...
    "must call connector exactly once per request" in {
      ...
      verify(connector, times(1)).createPurchaser(eqTo(request))(
        any[HeaderCarrier]
      )
      verifyNoMoreInteractions(connector)
    }
    ...
    "must handle consecutive requests independently" in {
      ...
      val request3: CreatePurchaserRequest =
        mkCreatePurchaserRequest("STORN33333", "RRF-003")
      implicit val hc: HeaderCarrier = HeaderCarrier()
      ...
      when(connector.createPurchaser(eqTo(request3))(any[HeaderCarrier]))
        .thenReturn(
          Future.successful(mkCreatePurchaserReturn("PRF-003", "PID-003"))
        )
      ...
      service
        ...
        .futureValue mustBe mkCreatePurchaserReturn("PRF-002", "PID-002")
      service
        .createPurchaser(request3)
        .futureValue mustBe mkCreatePurchaserReturn("PRF-003", "PID-003")

      verify(connector, times(3)).createPurchaser(any[CreatePurchaserRequest])(
        any[HeaderCarrier]
      )
      verifyNoMoreInteractions(connector)
    }
    ...
    "must handle different stornId formats" in {
      ...
      val service = new PurchaserReturnsService(connector)
      val request1: CreatePurchaserRequest =
        mkCreatePurchaserRequest("STORN12345")
      val request2: CreatePurchaserRequest =
        mkCreatePurchaserRequest("STORN-ABC-123")
      val request3: CreatePurchaserRequest =
        mkCreatePurchaserRequest("12345678")
      implicit val hc: HeaderCarrier = HeaderCarrier()
  ...
  "PurchaserReturnsService updatePurchaser" - {
    ...
    "must delegate to connector (happy path)" in {
      ...
      val result: UpdatePurchaserReturn =
    ...
    "must return different results for different requests" in {
      val connector = mock[FilingFormpProxyConnector]
      val service = new PurchaserReturnsService(connector)
      val request1: UpdatePurchaserRequest =
        mkUpdatePurchaserRequest("STORN11111", "RRF-001", "PRF-001")
      val request2: UpdatePurchaserRequest =
        mkUpdatePurchaserRequest("STORN22222", "RRF-002", "PRF-002")
      implicit val hc: HeaderCarrier = HeaderCarrier()
      ...
      service
        .updatePurchaser(request1)
        .futureValue mustBe mkUpdatePurchaserReturn(true)
      service
        .updatePurchaser(request2)
        .futureValue mustBe mkUpdatePurchaserReturn(true)
    ...
    "must handle request with nextPurchaserId populated" in {
      ...
      val request: UpdatePurchaserRequest =
        mkUpdatePurchaserRequest().copy(nextPurchaserId = Some("PID-999"))
      implicit val hc: HeaderCarrier = HeaderCarrier()
    ...
    "must call connector exactly once per request" in {
      ...
      verify(connector, times(1)).updatePurchaser(eqTo(request))(
        any[HeaderCarrier]
      )
      verifyNoMoreInteractions(connector)
    }
    ...
    "must handle consecutive requests independently" in {
      ...
      val request2: UpdatePurchaserRequest =
        mkUpdatePurchaserRequest("STORN22222", "RRF-002", "PRF-002")
      val request3: UpdatePurchaserRequest =
        mkUpdatePurchaserRequest("STORN33333", "RRF-003", "PRF-003")
      implicit val hc: HeaderCarrier = HeaderCarrier()
      ...
      service
        ...
        .futureValue mustBe mkUpdatePurchaserReturn(true)
      service
        .updatePurchaser(request3)
        .futureValue mustBe mkUpdatePurchaserReturn(true)

      verify(connector, times(3)).updatePurchaser(any[UpdatePurchaserRequest])(
        any[HeaderCarrier]
      )
      verifyNoMoreInteractions(connector)
    }
  ...
  "PurchaserReturnsService deletePurchaser" - {
    ...
    "must delegate to connector (happy path)" in {
      ...
      val result: DeletePurchaserReturn =
    ...
    "must return different results for different requests" in {
      ...
      val request1: DeletePurchaserRequest =
        mkDeletePurchaserRequest("STORN11111", "PRF-001", "RRF-001")
      val request2: DeletePurchaserRequest =
        mkDeletePurchaserRequest("STORN22222", "PRF-002", "RRF-002")
      implicit val hc: HeaderCarrier = HeaderCarrier()
      ...
      service
        .deletePurchaser(request1)
        .futureValue mustBe mkDeletePurchaserReturn(true)
      service
        .deletePurchaser(request2)
        .futureValue mustBe mkDeletePurchaserReturn(true)
    ...
    "must call connector exactly once per request" in {
      ...
      verify(connector, times(1)).deletePurchaser(eqTo(request))(
        any[HeaderCarrier]
      )
      verifyNoMoreInteractions(connector)
    }
    ...
    "must handle consecutive requests independently" in {
      ...
      val request3: DeletePurchaserRequest =
        mkDeletePurchaserRequest("STORN33333", "PRF-003", "RRF-003")
      implicit val hc: HeaderCarrier = HeaderCarrier()
      ...
      service
        ...
        .futureValue mustBe mkDeletePurchaserReturn(true)
      service
        .deletePurchaser(request3)
        .futureValue mustBe mkDeletePurchaserReturn(true)

      verify(connector, times(3)).deletePurchaser(any[DeletePurchaserRequest])(
        any[HeaderCarrier]
      )
      verifyNoMoreInteractions(connector)
    }
    ...
    "must handle different storn formats" in {
      ...
      val service = new PurchaserReturnsService(connector)
      val request1: DeletePurchaserRequest =
        mkDeletePurchaserRequest("STORN12345", "PRF-001", "RRF-001")
      val request2: DeletePurchaserRequest =
        mkDeletePurchaserRequest("STORN-ABC-123", "PRF-001", "RRF-001")
      val request3: DeletePurchaserRequest =
        mkDeletePurchaserRequest("12345678", "PRF-001", "RRF-001")
      implicit val hc: HeaderCarrier = HeaderCarrier()
    ...
    "must handle different purchaserResourceRef formats" in {
      ...
      val request1: DeletePurchaserRequest =
        mkDeletePurchaserRequest("STORN12345", "PRF-001", "RRF-001")
      val request2: DeletePurchaserRequest =
        mkDeletePurchaserRequest("STORN12345", "123456", "RRF-001")
      val request3: DeletePurchaserRequest =
        mkDeletePurchaserRequest("STORN12345", "ABC-123-XYZ", "RRF-001")
      implicit val hc: HeaderCarrier = HeaderCarrier()
    ...
    "must handle different returnResourceRef formats" in {
      ...
      val request1: DeletePurchaserRequest =
        mkDeletePurchaserRequest("STORN12345", "PRF-001", "RRF-001")
      val request2: DeletePurchaserRequest =
        mkDeletePurchaserRequest("STORN12345", "PRF-001", "RRF-ABC-123")
      val request3: DeletePurchaserRequest =
        mkDeletePurchaserRequest("STORN12345", "PRF-001", "12345678")
      implicit val hc: HeaderCarrier = HeaderCarrier()
  ...
  "PurchaserReturnsService createCompanyDetails" - {
    ...
    "must delegate to connector (happy path)" in {
      ...
      val result: CreateCompanyDetailsReturn =
    ...
    "must return different results for different requests" in {
      val connector = mock[FilingFormpProxyConnector]
      val service = new PurchaserReturnsService(connector)
      val request1: CreateCompanyDetailsRequest =
        mkCreateCompanyDetailsRequest("STORN11111", "RRF-001", "PRF-001")
      val request2: CreateCompanyDetailsRequest =
        mkCreateCompanyDetailsRequest("STORN22222", "RRF-002", "PRF-002")
      implicit val hc: HeaderCarrier = HeaderCarrier()
      ...
      service
        .createCompanyDetails(request1)
        .futureValue mustBe mkCreateCompanyDetailsReturn("CID-001")
      service
        .createCompanyDetails(request2)
        .futureValue mustBe mkCreateCompanyDetailsReturn("CID-002")
    ...
    "must propagate failures from connector" in {
      ...
      val ex: Throwable =
        service.createCompanyDetails(request).failed.futureValue
      ex mustBe boom
    ...
    "must handle minimal request with no optional fields" in {
      ...
      val request: CreateCompanyDetailsRequest =
        mkCreateCompanyDetailsRequest().copy(
          utr = None,
          vatReference = None,
          compTypeBank = None,
    ...
    "must handle different company type combinations" in {
      ...
      val partnershipRequest: CreateCompanyDetailsRequest =
        mkCreateCompanyDetailsRequest().copy(
          compTypeBank = Some("NO"),
      ...
      when(
        connector.createCompanyDetails(eqTo(propertyRequest))(
          any[HeaderCarrier]
        )
      )
        .thenReturn(Future.successful(mkCreateCompanyDetailsReturn()))
      when(
        connector.createCompanyDetails(eqTo(charityRequest))(any[HeaderCarrier])
      )
        .thenReturn(Future.successful(mkCreateCompanyDetailsReturn()))
      when(
        connector.createCompanyDetails(eqTo(partnershipRequest))(
          any[HeaderCarrier]
        )
      )
        .thenReturn(Future.successful(mkCreateCompanyDetailsReturn()))
      ...
      service
        .createCompanyDetails(propertyRequest)
        .futureValue mustBe mkCreateCompanyDetailsReturn()
      service
        .createCompanyDetails(charityRequest)
        .futureValue mustBe mkCreateCompanyDetailsReturn()
      service
        .createCompanyDetails(partnershipRequest)
        .futureValue mustBe mkCreateCompanyDetailsReturn()

      verify(connector).createCompanyDetails(eqTo(propertyRequest))(
        any[HeaderCarrier]
      )
      verify(connector).createCompanyDetails(eqTo(charityRequest))(
        any[HeaderCarrier]
      )
      verify(connector).createCompanyDetails(eqTo(partnershipRequest))(
        any[HeaderCarrier]
      )
      verifyNoMoreInteractions(connector)
    }
    ...
    "must call connector exactly once per request" in {
      ...
      verify(connector, times(1)).createCompanyDetails(eqTo(request))(
        any[HeaderCarrier]
      )
      verifyNoMoreInteractions(connector)
    }
    ...
    "must handle consecutive requests independently" in {
      ...
      val request2: CreateCompanyDetailsRequest =
        mkCreateCompanyDetailsRequest("STORN22222", "RRF-002", "PRF-002")
      val request3: CreateCompanyDetailsRequest =
        mkCreateCompanyDetailsRequest("STORN33333", "RRF-003", "PRF-003")
      implicit val hc: HeaderCarrier = HeaderCarrier()
      ...
      service
        ...
        .futureValue mustBe mkCreateCompanyDetailsReturn("CID-002")
      service
        .createCompanyDetails(request3)
        .futureValue mustBe mkCreateCompanyDetailsReturn("CID-003")

      verify(connector, times(3)).createCompanyDetails(
  ...
  "PurchaserReturnsService updateCompanyDetails" - {
    ...
    "must delegate to connector (happy path)" in {
      ...
      val result: UpdateCompanyDetailsReturn =
    ...
    "must return different results for different requests" in {
      val connector = mock[FilingFormpProxyConnector]
      val service = new PurchaserReturnsService(connector)
      val request1: UpdateCompanyDetailsRequest =
        mkUpdateCompanyDetailsRequest("STORN11111", "RRF-001", "PRF-001")
      val request2: UpdateCompanyDetailsRequest =
        mkUpdateCompanyDetailsRequest("STORN22222", "RRF-002", "PRF-002")
      implicit val hc: HeaderCarrier = HeaderCarrier()
      ...
      service
        .updateCompanyDetails(request1)
        .futureValue mustBe mkUpdateCompanyDetailsReturn(true)
      service
        .updateCompanyDetails(request2)
        .futureValue mustBe mkUpdateCompanyDetailsReturn(true)
    ...
    "must propagate failures from connector" in {
      ...
      val ex: Throwable =
        service.updateCompanyDetails(request).failed.futureValue
      ex mustBe boom
    ...
    "must call connector exactly once per request" in {
      ...
      verify(connector, times(1)).updateCompanyDetails(eqTo(request))(
        any[HeaderCarrier]
      )
      verifyNoMoreInteractions(connector)
    }
    ...
    "must handle consecutive requests independently" in {
      ...
      val request2: UpdateCompanyDetailsRequest =
        mkUpdateCompanyDetailsRequest("STORN22222", "RRF-002", "PRF-002")
      val request3: UpdateCompanyDetailsRequest =
        mkUpdateCompanyDetailsRequest("STORN33333", "RRF-003", "PRF-003")
      implicit val hc: HeaderCarrier = HeaderCarrier()
      ...
      service
        ...
        .futureValue mustBe mkUpdateCompanyDetailsReturn(true)
      service
        .updateCompanyDetails(request3)
        .futureValue mustBe mkUpdateCompanyDetailsReturn(true)

      verify(connector, times(3)).updateCompanyDetails(
  ...
  "PurchaserReturnsService deleteCompanyDetails" - {
    ...
    "must delegate to connector (happy path)" in {
      ...
      val result: DeleteCompanyDetailsReturn =
    ...
    "must return different results for different requests" in {
      ...
      val request1: DeleteCompanyDetailsRequest =
        mkDeleteCompanyDetailsRequest("STORN11111", "RRF-001")
      val request2: DeleteCompanyDetailsRequest =
        mkDeleteCompanyDetailsRequest("STORN22222", "RRF-002")
      implicit val hc: HeaderCarrier = HeaderCarrier()
      ...
      service
        .deleteCompanyDetails(request1)
        .futureValue mustBe mkDeleteCompanyDetailsReturn(true)
      service
        .deleteCompanyDetails(request2)
        .futureValue mustBe mkDeleteCompanyDetailsReturn(true)
    ...
    "must propagate failures from connector" in {
      ...
      val ex: Throwable =
        service.deleteCompanyDetails(request).failed.futureValue
      ex mustBe boom
    ...
    "must call connector exactly once per request" in {
      ...
      verify(connector, times(1)).deleteCompanyDetails(eqTo(request))(
        any[HeaderCarrier]
      )
      verifyNoMoreInteractions(connector)
    }
    ...
    "must handle consecutive requests independently" in {
      ...
      val request3: DeleteCompanyDetailsRequest =
        mkDeleteCompanyDetailsRequest("STORN33333", "RRF-003")
      implicit val hc: HeaderCarrier = HeaderCarrier()
      ...
      service
        ...
        .futureValue mustBe mkDeleteCompanyDetailsReturn(true)
      service
        .deleteCompanyDetails(request3)
        .futureValue mustBe mkDeleteCompanyDetailsReturn(true)

      verify(connector, times(3)).deleteCompanyDetails(
    ...
    "must handle different storn formats" in {
      ...
      val service = new PurchaserReturnsService(connector)
      val request1: DeleteCompanyDetailsRequest =
        mkDeleteCompanyDetailsRequest("STORN12345", "RRF-001")
      val request2: DeleteCompanyDetailsRequest =
        mkDeleteCompanyDetailsRequest("STORN-ABC-123", "RRF-001")
      val request3: DeleteCompanyDetailsRequest =
        mkDeleteCompanyDetailsRequest("12345678", "RRF-001")
      implicit val hc: HeaderCarrier = HeaderCarrier()
    ...
    "must handle different returnResourceRef formats" in {
      ...
      val request1: DeleteCompanyDetailsRequest =
        mkDeleteCompanyDetailsRequest("STORN12345", "RRF-001")
      val request2: DeleteCompanyDetailsRequest =
        mkDeleteCompanyDetailsRequest("STORN12345", "123456")
      val request3: DeleteCompanyDetailsRequest =
        mkDeleteCompanyDetailsRequest("STORN12345", "ABC-123-XYZ")
      implicit val hc: HeaderCarrier = HeaderCarrier()
